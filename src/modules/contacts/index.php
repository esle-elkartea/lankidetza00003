<?php /* $Id: index.php,v 1.32 2006/03/30 12:16:23 Attest sw-libre@attest.es  Exp $ */
/* $Id: index.php,v 1.31 2005/03/29 00:01:16 ajdonnison Exp $ */
$AppUI->savePlace();
...
$perms =& $AppUI->acl();
$canAdd = $perms->checkModule( 'contacts', 'add' );
	...
	?>
		...
		<tr>
			<td width="100%">
                ...
                if ($canEdit) {?>
				<a title="<?php echo $AppUI->_('Edit'); ?>" href="?m=contacts&a=addedit&contact_id=<?php echo $contactid; ?>"><img src="./images/icons/pencil.gif" border=0 width=12 height=12></a>
				<?}                
                 ?>
...
$q->addWhere("project_contacts like \"" .$carr[$z][$x]["contact_id"]
 ...
 $q->clear();
 if (($projects_contact[0]>0)&&($canEdit))
   echo "				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a title=\"Proyectos\" href=\"\" onClick=\"	window.open('./index.php?m=public&a=selector&dialog=1&callback=goProject&table=projects&user_id=" .$carr[$z][$x]["contact_id"] ."&can=0', 'selector', 'left=50,top=50,height=250,width=400,resizable')
;return false;\">Proyectos</a>";
?>
			</td>
		</tr>
		<tr>
