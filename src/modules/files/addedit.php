<?php /* FILES $Id: addedit.php,v 1.45 2006/03/31 11:40:23 Attest sw-libre@attest.es  Exp $ */
/* FILES $Id: addedit.php,v 1.44 2005/04/01 20:51:51 gregorerhardt Exp $ */
...
<tr>
	<td>
		<input class="button" type="button" name="cancel" value="<?php echo $AppUI->_('cancel');?>" onClick="javascript:if(confirm('<?php echo $AppUI->_('Are you sure you want to cancel?', UI_OUTPUT_JS); ?>')){window.history.back()}" />
	</td>
	<td align="right">
