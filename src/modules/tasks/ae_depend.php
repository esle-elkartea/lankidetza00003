<?php // $Id: ae_depend.php,v 1.13 2006/03/16 13:47:23 Attest sw-libre@attest.es Exp $
...
<tr>
	<td align="right" nowrap="nowrap"><?php echo $AppUI->_( 'Do not track this task' );?></td><td></td>
	<td>
		<input type="checkbox" name="task_dynamic_nodelay" value="1" <?php if(($obj->task_dynamic > '10') && ($obj->task_dynamic < 30)) echo "checked"?> />
			...
			?>
			<tr>
				<td align=right><?php echo $AppUI->_( 'All Tasks' );?>:<?echo "\t";?></td>
				<td></td>
