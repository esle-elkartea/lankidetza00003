<?php /* TASKS $Id: tasksperuser.php,v 1.6 2006/02/13 17:07:23 Attest sw-libre@attest.es Exp $ */
/* TASKS $Id: tasksperuser.php,v 1.5 2005/03/23 21:51:42 gregorerhardt Exp $ */
$AppUI->savePlace();
...
//in$titleBlock->addCrumb( "?m=tasks&a=todo&user_id=$user_id", "my todo" );
$titleBlock->show();
