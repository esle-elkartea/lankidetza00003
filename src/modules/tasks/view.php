<?php /* $Id: view.php,v 1.9 2006/04/06 15:44:59 Attest sw-libre@attest.es Exp $ */
/* $Id: view.php,v 1.89 2005/04/07 01:11:17 ajdonnison Exp $ */
...
*/
$canRead = $perms->checkModule( 'task_log', 'view' );
...
<tr valign="top">
	<td width="50%">
		...
		<tr>
			<td nowrap="nowrap" colspan=2><strong><?php echo strtoupper($AppUI->_('Details'));?></strong></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Task');?>:</td>
		...
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Milestone');?>:</td>
		...
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Time Worked');?>:</td>
			<td class="hilite" width="300"><?php echo (@$obj->task_hours_worked + @rtrim($obj->log_hours_worked, "0"));?></td>
		</tr>
		<tr>
			<td nowrap="nowrap" colspan=2><br><strong><?php echo strtoupper($AppUI->_('Dates and Targets'));?></strong></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Task Start Date');?> :</td>
			<td class="hilite" width="300"><?php echo $start_date ? substr($start_date->format( $df ),0,10) : '-';?></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Task Finish Date');?> :</td>
			<td class="hilite" width="300"><?php echo $end_date ? substr($end_date->format( $df ),0,10) : '-';?></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Expected Duration');?> :</td>
			<td class="hilite" width="300"><?php echo $obj->task_duration.' '.$AppUI->_( $durnTypes[$obj->task_duration_type] );?></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Start Date');?> real :</td>
			<td class="hilite" width="300"><?php echo $start_date_ir ? substr($start_date_ir->format( $df ),0,10) : '-';?></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Finish Date');?> real :</td>
			<td class="hilite" width="300"><?php echo $end_date_ir ? substr($end_date_ir->format( $df ),0,10) : '-';?></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Duration');?> real :</td>
			<td class="hilite" width="300"><?php echo $obj->task_duration_ir.' '.$AppUI->_( $durnTypes[$obj->task_duration_type] );?></td>
		</tr>
	...
	<td width="50%">
		...
		<tr>
			<td colspan="3"><strong><?php echo strtoupper($AppUI->_('Assigned Users'));?></strong></td>
		</tr>
		<tr>
			<td colspan="3">
			<?php
		...
		?>
		<tr>
			<td colspan="3"><strong><?php echo strtoupper($AppUI->_('Dependencies'));?></strong></td>
		</tr>
		<tr>
			<td colspan="3">
			<?php 
		...
		?>
		<tr>
			<td colspan="3"><strong><?php echo strtoupper($AppUI->_('Tasks depending on this Task'));?></strong></td>
		</tr>
		<tr>
			<td colspan="3">
			<?php
		...
		<tr>
		  <td colspan='3' nowrap="nowrap">
		     <strong><?php echo strtoupper($AppUI->_('Description'));?></strong><br />
		  </td>
		 </tr>
		 <tr>
...
<?php
		...
		if (count($depts)) {
			?>
		    <tr>
		    	<td><strong><?php echo strtoupper($AppUI->_("Departments")); ?></strong></td>
		    </tr>
		    <tr>
		...
		if ($AppUI->isActiveModule('contacts') && $perms->checkModule('contacts', 'view')) {
			...
			if(count($contacts)>0){
				?>
			    <tr>
			    	<td><strong><?php echo strtoupper($AppUI->_("Task Contacts")); ?></strong></td>
			    </tr>
			    <tr>
			    	<td colspan='3' class="hilite">
			    		<?php
			    			...
			    			foreach($contacts as $contact_id => $contact_data){
			    				echo "<tr>";
			    				echo "<td class='hilite'>".$contact_data["contact_first_name"]." ".$contact_data["contact_last_name"]."</td>";
		 ...
		 <?php
			...
			if(count($contacts)>0){
				?>
			    <tr>
			    	<td><strong><?php echo strtoupper($AppUI->_("Project Contacts")); ?></strong></td>
			    </tr>
			    <tr>
			    	<td colspan='3' class="hilite">
			    		<?php
