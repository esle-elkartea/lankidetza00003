<?php /* PUBLIC $Id: selector.php,v 1.19 2006/03/06 13:24:56 Attest sw-libre@attest.es Exp $ */
/* PUBLIC $Id: selector.php,v 1.18 2005/03/13 11:38:23 gregorerhardt Exp $ */
...
<b><br><br><?php echo $AppUI->_( $title ).':'?></b>
<br><table width="100%">
<tr>
	<td>
		...
		if (dPgetParam( $_GET, 'can', 1 )) echo "<li><a href=\"javascript:setClose('0','[ninguno]')\">[ninguno]</a></li>";
				foreach ($list as $key => $val) {
					echo "<li>";
					if (dPgetParam( $_GET, 'can', 1 )) echo "<a href=\"javascript:setClose('$key','".addslashes($val)."');\">$val</a>";
					else echo $val;
					echo "</li>\n";
				}
			} else {
