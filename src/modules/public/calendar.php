<?php /* PUBLIC $Id: calendar.php,v 1.7 2006/04/10 15:34:24 Attest sw-libre@attest.es Exp $ */
 ...
 */
	function clickDay( idate, fdate ) {
		...
		if (<?if($_GET["b"]==1)echo '1';else echo'0';?> == 1) window.opener.porciento(parseInt(idate));
		window.close();
	}
</script>
