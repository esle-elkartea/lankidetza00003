<?php /* PUBLIC $Id: contact_selector.php,v 1.1 2006/04/18 10:49:48 Attest sw-libre@attest.es Exp $ */
	...
	if ( ! $company_id ) {
		...
		$oCpy = new CCompany ();
				//$extra['where']= "company_type=1";
                $aCpies = $oCpy->getAllowedRecords ($AppUI->user_id, 'company_id,company_name', 'company_name','' );
				// ina $aCpies = $oCpy->getAllowedRecords ($AppUI->user_id, "company_id, company_name");
