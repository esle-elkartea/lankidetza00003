<?php /* ADMIN $Id: addedituser.php,v 1.46 2005/04/04 17:56:23 Attest sw-libre@attest.es  Exp $ */
/* ADMIN $Id: addedituser.php,v 1.45 2005/04/08 10:47:23 gregorerhardt Exp $ */
...
// setup the title block
	...
	if ($perms->checkModule('admin', 'view') && $perms->checkModule('users', 'view') && $canEdit)
		$titleBlock->addCrumb( "?m=admin", "users list" );
	if ($user_id > 0) {
...
<tr>
    ...
    <td><input type="password" class="text" name="user_password" <?if ($user_id!=0)echo'disabled';?> value="<?php echo $user["user_password"];?>" maxlength="32" size="32" /> </td>
</tr>
<tr>
    <td align="right">* <?php echo $AppUI->_('Rewrite Password');?>:</td>
    <td><input type="password" class="text" name="password_check"  <?if ($user_id!=0)echo'disabled';?> value="<?php echo $user["user_password"];?>" maxlength="32" size="32" /> </td>
</tr>
<tr>
...
<tr>
    ...
    <td>
<?php
    echo arraySelect( $companies, 'contact_company', 'class=text size=1 onChange="javascript:vaciarDepartamento()"', $user["contact_company"] );
?>
    </td>
</tr>
