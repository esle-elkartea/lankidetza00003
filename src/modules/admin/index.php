<?php /* $Id: index.php,v 1.32 2006/03/07 17:05:23 Attest sw-libre@attest.es  Exp $ */
/* $Id: index.php,v 1.31 2005/04/08 06:52:59 ajdonnison Exp $ */
$perms =& $AppUI->acl();
...
?>
function delMe( x, y ) {
	if (confirm( "<?php echo $AppUI->_('do Del Me', UI_OUTPUT_JS)?> " + y + "?" )) {
