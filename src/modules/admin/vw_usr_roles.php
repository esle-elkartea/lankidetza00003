<?php /* ADMIN $Id: vw_usr_roles.php,v 1.20 2006/04/11 17:50:59 Attest sw-libre@attest.es  Exp $ */
/* ADMIN $Id: vw_usr_roles.php,v 1.10 2005/03/14 02:28:06 gregorerhardt Exp $ */
...
foreach ($roles as $role) {
  if ($role['value']!="admin" ) $roles_arr[$role['id']] = $role['name'];
}
...
?>
function delIt(id) {
	if (confirm( '<?echo $AppUI->_('quitarRol', UI_OUTPUT_JS)?>' )) {
