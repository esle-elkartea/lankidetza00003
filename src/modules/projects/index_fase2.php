...
<table border=1 align=center > <tr><td width=700>
<h2>Buscador</h2></td></tr>
...
$titleBlock->addCell( $AppUI->_('etiq_Moldista') );
...
$buf = '<input type="text" name="alias_string" size=13 value="'.$alias_string.'" class="text">';
...
<td><div align=right><input type=button onClick="document.pickCompany.submit()" class="button" value="Buscar"></div></td>
</tr></table>
</form>
