<?php /* PROJECTS $Id: vw_idx_proposed.php,v 1.23 2006/03/28 17:14:23 Attest sw-libre@attest.es Exp $ */
/* PROJECTS $Id: vw_idx_proposed.php,v 1.22 2005/03/28 03:32:34 gregorerhardt Exp $ */
GLOBAL $AppUI, $projects, $company_id, $pstatus, $project_types, $currentTabId, $currentTabName;

$check = $AppUI->_('All', UI_OUTPUT_RAW);
...
<tr>
	...
	<th nowrap="nowrap">
        ...
        <th nowrap="nowrap">
		<?php echo $AppUI->_('Start');?></a>
	</th>
        <th nowrap="nowrap">
		<?php echo $AppUI->_('End');?></a>
	</th>
        <th nowrap="nowrap">
		<?php echo $AppUI->_('Actual');?></a>
	</th>
        <th nowrap="nowrap">
		<?php echo $AppUI->_('P');?></a>
	</th>
	<th nowrap="nowrap">
...
} else if ($perms->checkModule('projects', 'edit')) {
?>
<tr>
