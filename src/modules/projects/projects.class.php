<?php /* PROJECTS $Id: projects.class.php,v 1.30 2006/04/07 09:10:34 Attest sw-libre@attest.es Exp $ */
/* PROJECTS $Id: projects.class.php,v 1.29 2005/04/09 03:10:23 ajdonnison Exp $ */
/**
 *	@package dotProject
 *	@subpackage modules
...
class CProject extends CDpObject {
	...
	var $project_client = NULL;
	var $project_mold = NULL;
