<?php  /* PROJECTS $Id: index.php,v 1.85 2006/04/06 16:08:56 Attest sw-libre@attest.es Exp $ */
/* PROJECTS $Id: index.php,v 1.84 2005/03/29 00:55:13 gregorerhardt Exp $ */
$AppUI->savePlace();
...
// Let's update project status!
	if ($perms->checkModule('projects', 'edit'))	{
...
if(isset($_POST["alias_string"])) {
		if(strlen($_POST["alias_string"]) >= 1) $alias_string=$_POST["alias_string"];
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if (isset( $_POST['fmoldista'] )) {
	$AppUI->setState( 'fmold', intval( $_POST['fmoldista'] ) );
}
$fmoldista = $AppUI->getState( 'fmold' ) !== NULL ? $AppUI->getState( 'fmold' ) : 'no';

if (isset( $_POST['fcliente'] )) {
	$AppUI->setState( 'fcli', intval( $_POST['fcliente'] ) );
}
$fcliente = $AppUI->getState( 'fcli' ) !== NULL ? $AppUI->getState( 'fcli' ) : 'no';
...
&nbsp;<a href="#" onClick="mostrarOcultar('buscador','proyectos',120)">mostrar/ocultar buscador</a>
<div align=left id="buscador" style="visibility:visible;position:static">
<form action="?m=projects" method="post" name="pickCompany">

<table width=60% border=0 cellspacing=2 cellspadding=2>
	...
	<tr>
		...
		<td>
			<table class="std" cellspacing=2 cellspadding=2 align=center>
				<tr>
					<td>&nbsp;</td>
					<td colspan=8>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td width=15% align= left> 
						<?echo $AppUI->_('Company') . '/' . $AppUI->_('Department') . ':';?>
					</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<td rowspan=2 valign=center align=right><input type=button onClick='document.pickCompany.submit()' class='button' value='Buscar'></td>
					<td width=50></td>
				</tr>
				
				<tr><td width=50></td>
					<td align=left>
						<? echo $AppUI->_('etiq_Cliente') . ':';?>	
					</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td align=left><?
					...
					<td width=4%>&nbsp;</td>	
					<td align=left><?echo $AppUI->_('etiq_Referencia').':';?>
					
					</td>
					<td>
						<input type="text" name="alias_string" size=12 value="<?echo $alias_string?>" class="text">
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
...
<div id="proyectos" style="position:relative">
<?
...
if ( $tabBox->isTabbed() ) {
	...
	$project_types[0] = $AppUI->_('All', UI_OUTPUT_RAW) . '(' . count($projects) . ')';
}
