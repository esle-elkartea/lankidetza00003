<?php /* ADMIN $Id: vw_role_perms.php,v 1.3 2005/04/05 09:35:14 Attest sw-libre@attest.es Exp $ */
/* ADMIN $Id: vw_role_perms.php,v 1.2 2005/04/01 20:51:51 gregorerhardt Exp $ */
...
<!--ina 	<td width="100%"><?php echo arraySelect($modules, 'permission_module', 'size="1" class="text"', 'grp,all', true);?></td> -->
		<td width="100%">
