...
<?php
	foreach ($rows as $row){
		...
		$s .= '<tr><td width=12 align="center"><a href="?m=contacts&a=addedit&contact_id='.$row["contact_id"].'"><img src="./images/icons/pencil.gif" alt="'.$AppUI->_( 'Edit Contact' ).'" border="0" width="12" height="12"></a></td>';
		$s .= '<td><a href="./index.php?m=contacts&a=addedit&contact_id='.$row["contact_id"].'">'. $row["contact_last_name"].", ".$row["contact_first_name"] .'</a>';
