<?php /* COMPANIES $Id: vw_companies.php,v 1.17 2006/04/11 17:06:50 Attest sw-libre@attest.es  Exp $ */
/* COMPANIES $Id: vw_companies.php,v 1.16 2005/03/11 20:13:50 gregorerhardt Exp $ */
...
<tr>
	...
	<th nowrap="nowrap">
		<?php echo $AppUI->_('Company Name');?></a>
	</th>
	<th nowrap="nowrap">
		<?php echo $AppUI->_('Active Projects');?></a>
	</th>
	<th nowrap="nowrap">
		<?php echo $AppUI->_('Archived Projects');?></a>
	</th>
	<th nowrap="nowrap">
		<?php echo $AppUI->_('Type');?></a>
	</th>
</tr>
<?php
$s = '';
