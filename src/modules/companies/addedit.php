<?php /* COMPANIES $Id: addedit.php,v 1.50 2006/04/06 13:14:23 Attest sw-libre@attest.es  Exp $ */
/* COMPANIES $Id: addedit.php,v 1.49 2005/04/08 13:41:51 gregorerhardt Exp $ */
...
<table>
	...
	<tr>
		...
		<td>
	<?php
		//ina echo arraySelect( $types, 'company_type', 'size="1" class="text" onChange="javascript:changeRecordType(this.value);"', @$obj->company_type, true );
...
-->
<input type=hidden value="1" name="company_owner">	
