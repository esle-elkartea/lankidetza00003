<?php /* $Id: index.php,v 1.121 2006/03/27 11:12:30 Attest sw-libre@attest.es Exp $ */
/* $Id: index.php,v 1.121 2005/04/04 11:36:10 ajdonnison Exp $ */
...
if( is_file( "$baseDir/includes/config.php" ) ) {
	...
	echo "Fatal Error. Aún no se ha creado el archivo de configuración.<br/><a href='./install/index.php'>
		Pulsa aquí para crearlo</a> (redireccionado en 5 seg.)</body></html>";
	exit();
}
