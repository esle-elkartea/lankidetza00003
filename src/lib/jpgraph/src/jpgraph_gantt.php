...
// Ver:		$Id: jpgraph_gantt.php,v 1.5 2006/03/30 10:41:12 Attest sw-libre@attest.es Exp $
//		$Id: jpgraph_gantt.php,v 1.4 2005/02/07 21:22:14 gregorerhardt Exp $
//
...
// PRIVATE Methods
	...
	if( $this->week->iShowLabels ) {
		...
		if( $this->week->iStyle==WEEKSTYLE_WNBR )
		    $txt = 's'.substr(sprintf($this->week->iLabelFormStr,$weeknbr),1);
		elseif( $this->week->iStyle==WEEKSTYLE_FIRSTDAY || 
			$this->week->iStyle==WEEKSTYLE_FIRSTDAYWNBR ) 
		    $txt = date("j/n",$week); 
