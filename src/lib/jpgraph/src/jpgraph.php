...
// Ver:		$Id: jpgraph.php,v 1.9.2 2006/03/08 12:03:12 Attest sw-libre@attest.es Exp $
//		$Id: jpgraph.php,v 1.9 2005/03/05 10:17:01 cyberhorse Exp $
//
...
// PUBLIC METHODS	
	...
	for($i=1; $i<=12; ++$i) {
	    ...
	    //$this->iShortMonth[$aLocale][] = ucfirst($short);<br>
		$this->iShortMonth[$aLocale][] = ucfirst($full);
