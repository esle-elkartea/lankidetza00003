# dotproject.sql, 2006/04/07 12:07:48 Attest sw-libre@attest.es Exp $
...
#  `project_actual_budget` decimal(10,2) default '0.00',
  ...
  `project_client` int(11) NOT NULL default'0',
  `project_mold` int(11) NOT NULL default'0',
...
#  `task_related_url` varchar(255) default NULL,
  ...
  `task_start_date_ir` datetime default NULL,
  `task_end_date_ir` datetime default NULL,
  `task_duration_ir` float unsigned default '0',
  PRIMARY KEY  (`task_id`),
...
INSERT INTO `user_preferences` VALUES("0", "LOCALE", "es");
...
INSERT INTO `user_preferences` VALUES("0", "CURRENCYFORM", "eu_ES");
...
INSERT INTO `modules` VALUES("12", "Help", "help", "1.0.0", "", "core", "1", "Help", "dp.gif", "14", "1", "", "", "", "");
INSERT INTO `modules` VALUES("13", "Public", "public", "1.0.0", "", "core", "1", "Public", "users.gif", "13", "0", "", "", "", "");
INSERT INTO `modules` VALUES("14", "Roles", "roles", "1.0.0", "", "core", "1", "Roles", "users.gif", "12", "1", "", "", "", "");
...
INSERT INTO `config` VALUES ('', 'host_locale', 'esp', '', 'text');
...
INSERT INTO `config` VALUES ('', 'company_name', 'GESTION DE PRIMERAS MUESTRAS', '', 'text');
INSERT INTO `config` VALUES ('', 'page_title', 'Asociacion de Fundidores de Pais Vasco y Navarra - Gestion de Primeras Muestras', '', 'text');
INSERT INTO `config` VALUES ('', 'site_domain', '', '', 'text');
INSERT INTO `config` VALUES ('', 'email_prefix', '', '', 'text');
...
INSERT INTO `config` VALUES ('', 'cal_day_view_show_minical', 'false', '', 'checkbox');
...
INSERT INTO `config` VALUES ('', 'default_view_m', 'companies', '', 'text');
