<?php // $Id: ui.class.php,v 1.16 2006/03/27 13:18:48 Attest sw-libre@attest.es Exp $
/* CLASSES $Id: ui.class.php,v 1.85 2005/04/08 07:40:35 ajdonnison Exp $ */
/**
* @package dotproject
* @subpackage core
...
*/
	function show() {
		...
		$CR = "\n";
		$CT = "\n\t";
		$s = $CR . '<table width="100%" border="0" cellpadding="4" cellspacing="1">';
		$s .= $CR . '<tr>';
		if ($this->icon) {
			$s .= $CR . '<td width="42">';
