<?php /* $Id: date.class.php,v 1.15 2006/03/01 17:11:30 Attest sw-libre@attest.es Exp $ */
/* CLASSES $Id: date.class.php,v 1.12 2004/07/25 18:15:35 gregorerhardt Exp $ */
/**
* @package dotproject
* @subpackage utilites
*/
...
*/
    ...
    function compare_notime($d1, $d2, $convertTZ=false)
    {
		if ($convertTZ) {
			$d1->convertTZ(new Date_TimeZone('UTC'));
			$d2->convertTZ(new Date_TimeZone('UTC'));
